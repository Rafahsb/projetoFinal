...
export function Manutencao(props) {
    ...
    async function editManutencao(data) {
        await props.editManutencao({ ...data, id: props.manutencao.id_manutencao});
        setIsUpdated(false);
    }
                            ...
                            >
                                <Modal.Body>
                                    ...
                                    <Row className="mb-4">
                                       <Input
                                        size={'sm'} 
                                        defaultValue={props.manutencao.data_nota.split('/').reverse().join('-')}
                                        type="date"
                                        label="Data:*"
                                    ...
                                    <Form.Group >
                                                ...
                                                <Form.Select {...register("id_viatura")}  size="lg"  defaultValue={props.manutencao.id_viatura}>
                                                    <option disabled>Clique para selecionar a marca</option>
                                                    
                                                    {viaturas.map((viatura, index) => ( 
                                                        <option key={index} value={viatura.id_viatura}>{`${viatura.marca} - ${viatura.modelo} - ${viatura.chassi}`}</option>
                                                    ))}
