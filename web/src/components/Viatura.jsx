                                    ...
                                    <Row className="d-flex align-items-start mb-4">
                                        <Col sm={6}>
                                            <Form.Group >
                                                ...
                                                <Form.Select {...register("marca")}  defaultValue={props.viatura.marca} size="lg"  >
                                        ...
                                        <Col sm={6}>
                                            <Form.Group>
                                                ...
                                                <Form.Select {...register("cor")} defaultValue={props.viatura.cor} size="lg">
                                    ...
                                    <Row className="d-flex align-items-start mb-3">
                                        <Col sm={6}>
                                            <Form.Group >
                                                ...
                                                <Form.Select {...register("orgao_vinculado")} defaultValue={props.viatura.orgao_vinculado} size="lg">
                                        ...
                                        <Col sm={6}>
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Select {...register("batalhao")} defaultValue={props.viatura.batalhao} size="lg">
                                                    <option disabled>Clique para selecionar um órgão</option>
